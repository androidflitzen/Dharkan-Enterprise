...
public class AllState_Spn_Adapter extends RecyclerView.Adapter<AllState_Spn_Adapter.ViewHolder> {

    Context context;
    private Boolean[] selected;
    List<AllState.Result> itemList ;
    List<AllState.Result> Selectedlist = new ArrayList<>();
    OnItemClickListener mItemClickListener;

    public AllState_Spn_Adapter(Context context, List<AllState.Result> iteamArray) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        holder.alertTextView.setText(itemList.get(position).getStateName());
    ...
    public List<AllState.Result> getSelectedlist(){
