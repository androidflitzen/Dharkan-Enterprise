...
AllEnquiryAdapter_Test extends RecyclerView.Adapter<AllEnquiryAdapter_Test.ViewHolder> {
    ...
    public AllEnquiryAdapter_Test(Context context, List<AllEnquiry.Result> allenquiryList, RecyclerView rvEnquiry) {
